...
enum NeuronType {SN_GRASS_DIST_N, SN_GRASS_DIST_S, SN_GRASS_DIST_E, SN_GRASS_DIST_W,
  ...
  SN_MAP_POSITION_XMIN, SN_MAP_POSITION_XMAX, SN_MAP_POSITION_YMIN, SN_MAP_POSITION_YMAX,
  LN_OR, LN_AND, LN_GREATER_THAN, LN_ADD, LN_MEM,
...
const int HERBIVORES_PER_SIMULATION = 50;
const int PLANTS_PER_SIMULATION = 200;
const int SAVE_CARNIVORES = 5;
const int SAVE_HERBIVORES = 5;
const int NEURONS_PER_ANIMAL = 30;
const int NEURON_MUTATIONS_PER_ROUND_MIN = 0;
const int NEURON_MUTATIONS_PER_ROUND_MAX = 3;
const int CHILDREN_PER_NEURON_WEIGHT_1 = 10;
const int CHILDREN_PER_NEURON_WEIGHT_2 = 2;
const int CHILDREN_PER_NEURON_WEIGHT_3 = 1;
const int CHILDREN_PER_NEURON_WEIGHT_TOT = CHILDREN_PER_NEURON_WEIGHT_1 + CHILDREN_PER_NEURON_WEIGHT_2 + CHILDREN_PER_NEURON_WEIGHT_3;
