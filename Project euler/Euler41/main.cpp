...
int main(int argc, char **argv) {
  ...
  testPrime.pandigitalCheck(digits, 9, 0);
  testPrime.pandigitalCheck(digits, 8, 0);
  testPrime.pandigitalCheck(digits, 7, 0);
  testPrime.pandigitalCheck(digits, 6, 0);
  testPrime.pandigitalCheck(digits, 5, 0);
  testPrime.pandigitalCheck(digits, 4, 0);
  testPrime.pandigitalCheck(digits, 3, 0);
  testPrime.pandigitalCheck(digits, 2, 0);
  testPrime.pandigitalCheck(digits, 1, 0);
  delete[] digits;
  std::cout << std::endl << "Biggest pandigital prime " << testPrime.biggestPrime << std::endl;
  return 0;
}